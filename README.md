...
**5. Навигация — фиксированное меню при прокрутке**

![Навигация](screenshots/05-navigation.jpg)
...
**Аналитика и панели вебмастера.** На время работы над проектом были настроены Яндекс.Метрика
(цели, вебвизор), Яндекс.Вебмастер и Google Search Console. В сентябре 2026 проект передан
владельцу: счётчик снят, права в поисковых панелях подключает он сам.
